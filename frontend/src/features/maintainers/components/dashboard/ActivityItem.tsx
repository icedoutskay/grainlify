    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-start gap-3 flex-1 min-w-0">
          {/* Type Icon */}
          <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${activity.type === 'pr'
              ? 'bg-[#d4af37]/50'
              : 'bg-[#c9983a]/50'
            }`}>
            {activity.type === 'pr' ? (
          ...
          {/* Number Badge */}
          <div className={`px-2.5 py-1 rounded-[6px] flex-shrink-0 ${activity.type === 'pr'
              ? 'bg-[#d4af37]/50'
              : 'bg-[#c9983a]/50'
            }`}>
